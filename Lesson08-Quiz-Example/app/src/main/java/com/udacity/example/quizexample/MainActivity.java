...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView text_view_definition;
    ...
    public void nextWord() {
        ...
        boolean position = mData.moveToNext();
        String word = wordAndDefinition(getResources().getString(R.string.word), position);

        text_view_definition.setVisibility(View.INVISIBLE);
        text_view_word.setVisibility(View.VISIBLE);
    ...
    public void showDefinition() {
        ...
        String definition = wordAndDefinition(getResources().getString(R.string.definition), true);

        text_view_word.setVisibility(View.INVISIBLE);
        text_view_definition.setVisibility(View.VISIBLE);

        text_view_definition.setText(definition);
        mCurrentState = STATE_SHOWN;

    }

    public String wordAndDefinition(String wordDefinition, boolean position){
        ...
        Log.v("CursorExample", "wordAndDefinition: "  + word + " - " + definition);

        switch (wordDef){
            case "word":
                Log.v("CursorExample", "wordAndDefinition: "  + word);
                return word;
            case "definition":
                Log.v("CursorExample", "wordAndDefinition: " + definition);
                return definition;
        }
        return null;
    }
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            int definitionColumnIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
            if(mData.moveToNext()){
                text_view_word.setText(mData.getString(wordColumnIndex));
            }
        }
    }
