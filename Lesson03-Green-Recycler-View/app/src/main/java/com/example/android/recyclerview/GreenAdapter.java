...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        //TODO Message: it's good to make interface in adapter itself not in any paricular class, we cn do that as well but making interfaces again anad again whhoever uses this adapter is kind of expensive so we made a iterface in itself in adapter
        @Override
        public void onClick(View v) {
            int postion = getAdapterPosition();
            mOnClickListener.onListItemClick(postion);
        }
    }
}
